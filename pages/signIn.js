          ...
          <div className="col-12">
            <nav className="navbar navbar-expand-lg top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
              <div className="container-fluid">
                <a href="#" className="font-weight-bold soft ms-lg-0 ms-3">
                  Soft UI Dashboard
                </a>
                <button
                  className="navbar-toggler ms-2 shadow-none"
                  type="button"
                ...
                <div className="collapse navbar-collapse" id="navigation">
                  ...
                  <ul className="navbar-nav d-lg-block d-none">
                    <li className="nav-itembut">
                      <a href="#" className="btn btn-sm text-white  mb-0 me-1 ">
                        Free download
                      </a>
                    </li>
                  </ul>
                  ...
                  <div className="cardreader mt-8 shadow">
                    ...
                    <div classNameName="card-body">
                      <form role="form">
                        ...
                        <button
                          type="button"
                          className="signbutton btn w-100 mt-4 mb-0"
                        >
                          Sign in
                        </button>
                      </form>
